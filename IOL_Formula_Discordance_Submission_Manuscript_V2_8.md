...
The contribution is an age-conditioned check of whether plausible measurements fit together, not another univariate normal range. The outcome-naive model estimated age-expected measurements, local variability, and covariance. Association persisted after adjustment for marginal extremeness and in untouched-split formula eyes, supporting incremental but internal evidence. Because adjustment includes the component z scores underlying joint geometry, 3.57 estimates association beyond univariate extremeness; attenuation from 7.29 is not evidence of causal confounding.

Full conditioning stabilized age-specific tail rates, whereas the global score enriched discordance more strongly. It prioritized age-relative calibration over enrichment, avoiding systematic age-group over- or under-flagging. Future supervised or hybrid triage could target enrichment explicitly.

The intended action is narrow. The threshold flagged 2.5% of conventional-AL/K eyes, about 1 in 40; about 1 in 3 flagged eyes was discordant. It missed 84.1% and is not a rule-out screen. Technical-test and clinical-cohort flag rates should not be conflated.
...
Formula spread does not identify the most accurate formula; postoperative refraction was unavailable, and decision benefit over unstructured review was not tested. A blinded 500-eye postoperative review using the locked score is underway under a plan to be frozen before unmasking. Single-center sourcing limits transportability across devices, software, constants, IOLs, and populations; selection also limits generalization beyond conventional AL.
