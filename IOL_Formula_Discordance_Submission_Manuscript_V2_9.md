...
LAKE classification and autoencoder screening interpret biometry relationally but address classification and data quality rather than age-calibrated formula-screen triage.8,9 Our outcome-naive association persisted after marginal-extremeness adjustment and in untouched-split formula eyes. Full conditioning stabilized age-specific tails, whereas global scoring enriched discordance more strongly; it improved age-relative calibration, not predictive enrichment. The adjusted risk ratio is incremental, not causal. No approach identifies an erroneous measurement or establishes postoperative benefit.
