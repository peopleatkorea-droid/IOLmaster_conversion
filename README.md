...
```text
OOD_Percentile < 90.0       Anatomy_Score 0: Routine-range anatomy
90.0 이상, 97.5 미만       Anatomy_Score 1: Uncommon anatomy
97.5 이상                  Anatomy_Score 2: Out-of-distribution anatomy
```

`OOD_Dominant_Deviation`은 절대 standardized deviation이 큰 두 축을 표시합니다. 이는 Mahalanobis distance의 인과적 분해나 굴절오차 설명이 아닙니다.
