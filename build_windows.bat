...
.venv\Scripts\pyinstaller.exe --noconfirm --clean --onefile --windowed --name IOLMasterParser --exclude-module numpy --exclude-module scipy --exclude-module sklearn --add-data "models\biometry_ood_bilateral_v32.json;models" IOLMasterParser_app.py
if errorlevel 1 goto error
