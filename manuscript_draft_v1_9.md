...
**Draft version:** 1.9, August 13, 2026  
**Main-text word count:** 2,775  
...
Age-conditioned joint biometry identified a small discordance-enriched subgroup among eyes with conventional AL and K. The score should prompt measurement and formula-panel review, not select a formula or imply postoperative accuracy.
...
That relationship is the study's main contribution. The model estimated age-expected measurements, age-local variability, and covariance before formula outcomes were examined. The association persisted after adjustment for the marginal extremeness of AL, K, ACD, LT, WTW, and CCT and in formula eyes assigned to the model's untouched test split. The latter analysis reduces concern that fitting the reference geometry on overlapping patients created the association, although it remains an internal single-center evaluation.

The intended action is narrow. The ≥90th threshold flagged 2.5% of conventional-AL/K eyes with 98.2% specificity, but 15.9% sensitivity precludes rule-out use. In one representative eye, AL was 23.26 mm, mean K 45.58 D, ACD 3.05 mm, and LT 5.61 mm; no marginal |z| exceeded 2.5, yet the joint percentile was 91.8 and same-power predictions ranged from -0.20 to +0.16 D. The flag prompts measurement and formula review, not a winning formula. Agreement and postoperative accuracy are distinct.12

Traditional strata remain clinically useful because formula behavior changes in short, long, steep, or flat eyes.4,13,14 The present model adds a different view: whether several individually plausible measurements form an uncommon age-conditioned geometry. Its role is therefore a relational review flag, not another rectangular definition of a normal eye.
...
In conclusion, age-conditioned joint biometry identified a small discordance-enriched subgroup among eyes with conventional AL and K. The unadjusted risk ratio was 7.29 and the standardized adjusted risk ratio was 3.57. The percentile should trigger closer review of measurements and same-power formula predictions, not select a formula. External and postoperative validation should determine whether that review flag improves refractive decision-making.
...
In conventional AL/K eyes, the ≥90th percentile marked 7.29-fold unadjusted discordance risk; the standardized adjusted risk ratio was 3.57.
...
- A biometry-only reference model was frozen before formula outcomes were examined and measured age-conditioned multivariable rarity rather than one biometric extreme.
...
- The threshold flagged 2.5% of conventional-AL/K eyes with 15.9% sensitivity and 98.2% specificity; the association persisted in the reference model's untouched test split.
- In a paired source-level audit, anchor power differed in 44.0% of eyes, while 0.50-D discordance classification agreed in 98.9%.
- The score prompts review of measurements and same-power predictions; it neither selects a formula nor substitutes for postoperative error.
