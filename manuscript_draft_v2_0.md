# Age-Conditioned Joint Biometry as a Review Flag for Interformula Discordance: A Study of 4,123 Eyes

**Short title:** Joint biometry and formula discordance  
**Article type:** Full-Length Article  
**Target journal:** Journal of Cataract & Refractive Surgery  
**Draft version:** 2.0, August 13, 2026  
**Main-text word count:** 2,980  
**Abstract word count:** 247  
**Tables/Figures:** 2/2

**Authors:** [AUTHOR NAMES AND DEGREES]  
**Affiliations:** [AFFILIATIONS]  
**Corresponding author:** [NAME, ADDRESS, EMAIL, TELEPHONE]  
**Meeting presentation:** [IF APPLICABLE]  
**Financial support:** [TO COMPLETE]  
**Conflicts of interest:** [TO COMPLETE]

> **CRITICAL AUTHOR ACTIONS BEFORE SUBMISSION - remove this box from the submitted manuscript.** (1) Insert authors, affiliations, institution, exact dates, IRB/waiver, funding, conflicts of interest, and the final artificial-intelligence disclosure. (2) Complete an independent source-screen OCR accuracy audit and report its sampling frame, seed, pages/rows/fields, blinding, exact-match numerator/denominator with 95% CI, interreader agreement, and discrepancy resolution. (3) Confirm the IOLMaster 700 software-version timeline, formula constants, ARTIS model/fallback rule, and TR1/TR2 export definition. (4) Complete chart and corneal-topography review of the 9 short-steep eyes and audit possible previous corneal refractive surgery. (5) Obtain governance approval for public release of the calibration-age-distance arrays, specify a license, archive the V3.2 code/model with a DOI, deploy the synthetic-demo V3.2 calculator, and update Code Availability. (6) If feasible, link the strict source-conflict/block-QC flags into the final cohort; otherwise retain the current high-confidence linked sensitivity and explicit limitation.

## Abstract

### Purpose

To determine whether age-conditioned joint ocular biometry identifies interformula disagreement beyond axial-length (AL) and keratometry (K) extremes.

### Setting

[INSERT INSTITUTION, CITY, COUNTRY.]
...
A biometry-only reference model was developed with patient-separated data and frozen before formula outcomes were examined. In 4,123 linked eyes, Hoffer Q, SRK/T, Haigis, and Barrett Universal II TK predictions were aligned at the same IOL model and power. Spread was the maximum minus minimum prediction. Models adjusted for age, IOL power, acquisition year, IOL model, and the absolute age-adjusted marginal z score of each component; inference accounted for patient clustering.
...
Age-conditioned joint biometry identified a low-burden, discordance-enriched subgroup despite conventional AL and K. The score supports targeted measurement and formula-panel review; it neither rules out discordance nor selects a formula.
...
IOL formulas can give different predicted postoperative refractions for the same eye and power, and performance varies with biometry and implementation.1-3 Such disagreement prompts review of measurement quality, constants, formula suitability, and IOL choice. It is visible before surgery; accuracy is knowable only afterward.

Most subgroup analyses classify one variable at a time, such as AL, K, or anterior chamber depth (ACD).4 This can miss an eye with individually unremarkable values but an unusual relationship among AL, K, ACD, lens thickness (LT), white-to-white (WTW), and central corneal thickness (CCT). Formula-specific biometric associations suggest that such relationships may matter.5

Earlier studies described predicted-refraction variation in smaller cohorts or selected eyes after disagreement was present.6,7 We asked whether a biometry-only reference model could identify unexpected spread beyond age, IOL power, and marginal biometric extremeness, including when AL and K appeared conventional.

## Methods

### Study Design, Data Sources, and Ethics

This retrospective observational study combined an institutional IOLMaster 700 biometry export with deidentified formula-screen images. Reporting followed the STROBE statement.8 [INSERT INSTITUTION, CITY, COUNTRY, EXACT STUDY DATES, IRB NAME/NUMBER, CONSENT OR WAIVER, AND DATA-GOVERNANCE STATEMENT.] Direct identifiers were retained only in a protected linkage environment. Analytic files used nonreversible patient and examination tokens.
...
The panel comprised Hoffer Q, SRK/T, Haigis, and Barrett Universal II TK. Predictions were compared only at the same eye, IOL model, and power. Device predictions were not recomputed and reflect local software and constants [INSERT SOFTWARE VERSION AND CONSTANTS]. Leave-one-formula-out analyses addressed the mixed standard-K/TK panel.

For the primary analysis, the selected power gave a Haigis prediction from 0.00 to -0.50 D and was closest to -0.25 D. ZCB00 was preferred; ARTIS was used only as a low-power fallback [CONFIRM EXACT MODEL AND RULE]. Because Haigis anchoring can constrain Haigis-containing differences, power was reselected with the same rule using Barrett Universal II TK. The paired sensitivity included only eyes eligible under both rules.
...
Eligibility required age 2 to 100 years and frozen ranges: AL 14 to 38 mm, mean K 30 to 65 D, ACD 0.8 to 6.0 mm, LT 2 to 8 mm, WTW 8 to 16 mm, and CCT 0.35 to 0.80 mm. These bounds were read from the frozen V3.2 bundle and checked against the training constants and serialized model metadata. The latest eligible acquisition per patient-eye was retained; equal-date ties kept the first source row. Reference identifiers were stripped; eye labels were stripped and uppercased. Formula-link identifiers were also uppercased, stripped of a terminal numeric `.0`, and reduced to alphanumerics. This yielded 8,164 Extended-eligible eyes (4,498 patients) and 8,177 Core-eligible eyes (4,501 patients).
...
The primary categories were <90th, 90th to <97.5th, and ≥97.5th percentile. The score is termed a reference-model percentile or joint biometric atypicality, not a diagnosis. Tail calibration was evaluated in the untouched technical-test set. The frozen patient-split hash was also reconstructed for formula-cohort patients; association estimates were repeated in formula eyes assigned to the reference model's untouched test split.
...
Median age was 71.2 years, median AL was 23.75 mm, and median anchor power was 21.0 D (Table 1). ZCB00 was selected in 4,120 eyes and ARTIS in 3. Median formula spread was 0.29 D (IQR, 0.20-0.40); 491 eyes (11.9%) reached 0.50 D and 40 (1.0%) reached 0.75 D. Most eyes were closely aligned.
...
The central result is an enrichment pattern, not widespread disagreement. Most eyes had little formula spread. Within eyes whose AL and K appeared conventional, spread ≥0.50 D was approximately 7-fold more frequent above the 90th Extended percentile before adjustment; the standardized adjusted risk ratio was 3.57. An eye did not need an obviously unusual AL or K to have an unusual relationship among its measurements.

That relationship is the study's main contribution: not a new normal range for one measurement, but an age-conditioned check of whether plausible measurements fit together. The model estimated age-expected measurements, age-local variability, and covariance before formula outcomes were examined. The association persisted after adjustment for marginal extremeness and in formula eyes assigned to the model's untouched test split. The latter reduces concern about overlap with reference-model fitting but remains an internal single-center evaluation. Because adjustment conditions on the absolute marginal z scores underlying joint geometry, 3.57 estimates the percentile's incremental association beyond univariate extremeness; attenuation from 7.29 should not be interpreted as removal of causal confounding.

The intended action is narrow and operational. In the conventional-AL/K cohort, the threshold flagged 2.5% of eyes, approximately 1 in 40; 31.8% of flagged eyes, approximately 1 in 3, reached 0.50 D. However, it missed 84.1% of discordant eyes and is not a screening or rule-out test. Extended upper-tail calibration was modestly conservative in the untouched technical test; because that test and the restricted analysis cohort differ, their flag rates should not be conflated or generalized.

In one representative eye, AL was 23.26 mm, mean K 45.58 D, ACD 3.05 mm, and LT 5.61 mm; no marginal |z| exceeded 2.5, yet the joint percentile was 91.8 and same-power predictions ranged from -0.20 to +0.16 D. When triggered, review scan and biometry quality, repeat suspect measurements, verify IOL model, power, constants, and inputs, compare same-power predictions, and document the chosen formula. The score identifies neither the abnormal step nor the correct formula; agreement is not postoperative accuracy.12

Traditional strata remain clinically useful because formula behavior changes in short, long, steep, or flat eyes.4,13,14 The present model adds a different view: whether several individually plausible measurements form an uncommon age-conditioned geometry. Barrett Universal II can optionally incorporate ACD, LT, and WTW, and the influence of these optional inputs varies with AL.15 Such input asymmetry may contribute to differences between Core and Extended estimates or to panel spread, although mechanism was not tested. The score's role is therefore a relational review flag, not another rectangular definition of a normal eye.
...
The panel reflected formulas displayed together in local clinical use, but it mixed standard-K formulas with Barrett Universal II TK. Formula-specific inputs could therefore contribute to spread. Positive associations after omitting each formula, including Barrett TK, argue against a single-formula artifact; they do not substitute for validation in a uniformly modern panel. The larger coefficient after omitting Haigis was compatible with attenuation related to Haigis-based power anchoring, although the leave-one-formula-out analysis was not designed to establish mechanism. Such postoperative validation is in progress and should determine whether a preoperative review flag improves formula choice or refractive outcomes.
...
In conclusion, a frozen age-conditioned joint-biometry percentile identified relational atypicality and a small discordance-enriched subgroup despite conventional AL and K. The unadjusted risk ratio was 7.29 and the standardized adjusted risk ratio was 3.57. The percentile supports targeted review of measurements, inputs, and same-power predictions; it does not rule out discordance or select a formula. External and postoperative validation should determine whether this workflow improves refractive decision-making.
...
Among eyes with conventional axial length and keratometry, the frozen biometry-only ≥90th percentile identified unadjusted and standardized adjusted risk ratios of 7.29 and 3.57 for ≥0.50 D interformula discordance beyond marginal measurement extremeness.
...
- A biometry-only model frozen before formula outcomes tested whether individually plausible measurements fit together, and its association persisted in patients assigned to the model's untouched test split.
...
- A triggered review should check scan and biometry quality, IOL model and power, constants and formula inputs, and same-power predictions before documenting the chosen formula.
...
Analysis code and the V3.2 source bundle are maintained at https://github.com/peopleatkorea-droid/IOLmaster_conversion. A versioned, governance-reviewed archival release with a DOI and explicit license is pending. As accessed August 13, 2026, the stable calculator at https://k-era.org/tools/biometry-ood served model V3.1.0 and should not be used to reproduce the V3.2 values reported here until the version-matched release is deployed. The web bundle also calculates a separate AL-conditional geometry score that was not analyzed in this study.

## Disclosures Summary

Financial support: [TO COMPLETE.] Conflicts of interest: [TO COMPLETE.]

## Artificial Intelligence Use

[CONFIRM BEFORE SUBMISSION: OpenAI Codex was used for exploratory data checking, statistical code review, language editing, and document formatting. The authors verified all reported results and take full responsibility for the content.]
